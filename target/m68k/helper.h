...
DEF_HELPER_6(m68k_mmu030_special_cycle, i32, env, i32, i32, i32, i32, i32)
DEF_HELPER_6(m68k_mmu030_special_record, void, env, i32, i32, i32, i32, i32)
DEF_HELPER_4(m68k_mmu030_special_finish, void, env, i32, i32, i32)
DEF_HELPER_5(m68k_mmu030_split_load, i32, env, i32, i32, i32, i32)
DEF_HELPER_6(m68k_mmu030_split_store, void, env, i32, i32, i32, i32, i32)
DEF_HELPER_4(m68k_mmu030_tas, i32, env, i32, i32, i32)
DEF_HELPER_6(m68k_mmu030_cas, i32, env, i32, i32, i32, i32, i32)
DEF_HELPER_6(m68k_movep, i32, env, i32, i32, i32, i32, i32)
...
DEF_HELPER_5(extp96, void, env, fp, i32, i32, i32)
DEF_HELPER_5(stp96, void, env, fp, i32, i32, i32)
...
DEF_HELPER_3(fcmp, void, env, fp, fp)
DEF_HELPER_2(set_fpsr, void, env, i32)
DEF_HELPER_1(get_fpsr, i32, env)
DEF_HELPER_2(set_fpcr, void, env, i32)
DEF_HELPER_3(fcc_check, void, env, i32, i32)
DEF_HELPER_2(fpu_check_pending, void, env, i32)
DEF_HELPER_1(fpu_null_to_idle, void, env)
DEF_HELPER_2(fpu_begin, void, env, i32)
DEF_HELPER_2(fpu_finish, void, env, i32)
DEF_HELPER_2(ftst, void, env, fp)
DEF_HELPER_3(fconst, void, env, fp, i32)
DEF_HELPER_4(fmovemx_st_predec, i32, env, i32, i32, i32)
DEF_HELPER_4(fmovemx_st_postinc, i32, env, i32, i32, i32)
DEF_HELPER_4(fmovemx_ld_postinc, i32, env, i32, i32, i32)
DEF_HELPER_4(fmovemd_st_predec, i32, env, i32, i32, i32)
DEF_HELPER_4(fmovemd_st_postinc, i32, env, i32, i32, i32)
DEF_HELPER_4(fmovemd_ld_postinc, i32, env, i32, i32, i32)
DEF_HELPER_3(fsave, i32, env, i32, i32)
DEF_HELPER_2(frestore, i32, env, i32)
...
DEF_HELPER_3(m68k_pload030, void, env, i32, i32)
DEF_HELPER_3(m68k_ptest030, void, env, i32, i32)
DEF_HELPER_3(m68k_pflush030, void, env, i32, i32)
DEF_HELPER_6(m68k_pmove, void, env, i32, i32, i32, i32, i32)
