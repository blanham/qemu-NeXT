...
Use a published ref containing this work; the example ref must be published
or selected on the repository before cloning.
...
unchanged.
The 9P1 service is for these historical kernels and is not a 9P2000 server.
